...
_start:
    ...
    _parentProcess:
    	...
    	# But the process was supposed to run permanently
    	jmp _done
    ...
    _childProcess:
    	...
    	# Is the currently accepting request GET or POST? (To process case-by-case)
		cmp BYTE PTR [buffer], 'G'
		je _processGETRequest
		jne _processPOSTRequest
